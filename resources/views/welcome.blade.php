...
<html lang="en">
  ...
  <head>
    ...
    <title>Ritik's Restaurant</title>
<!--
            ...
            <div class="row">
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        -->
                            <li class="scroll-to-section"><a href="#menus">Menu</a></li>
                            <li class="scroll-to-section"><a href="#chefs">Chefs</a></li>
                            <li class="scroll-to-section"><a href="#offers">Special</a></li> 
                            {{-- <li class="submenu">
                                ...
                                {{-- <div class=""> --}}
                                    @auth
                                        <li class="submenu">
                                            ...
                                            <ul>
                                                <li><a href="{{ url('/dashboard') }}" class="scroll-to-section">Dashboard</a></li>
                                                <li><form method="POST" action="{{ route('logout') }}">
                                                    @csrf
                        
                                                    <a class="scroll-to-section" href="route('logout')"
